...
- **PySide6 裁切工作台 MVP**：打开扫描图、调检测参数、重新识别、显示识别框、拖动四点、手工新增四点框、裁切选中照片、pipeline 勾选编排
...
1. 打开 A4 扫描图。
2. 调整裁切识别参数：最小面积比例、Canny low/high、模糊核、闭运算次数、四边形拟合参数。
3. 点击“重新识别照片”。
4. 在画布上查看绿色照片框，拖动橙色点手工调四角。
5. 识别漏图时点击“手工新增四点框”。
6. 选择某张照片后点击“裁切选中照片”。
7. 在 Pipeline 编排区勾选/取消步骤，再运行选中照片 pipeline。
